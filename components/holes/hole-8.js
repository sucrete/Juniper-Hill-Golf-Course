    ...
    <div class="container contact__form px-lg-5">
        <div class="row d-flex flex-column-reverse flex-lg-row justify-content-between g-0">
              <div class="col col-12 col-lg-5">
                ...
                <p class="text">
                This scenic par 5 just invites you to step up and “rip it” off the tee.  However, any drive drifting right can bounce further right into some trouble.  The approach shot(s) into the green always plays longer than the yardage particularly from the right side of the fairway.  Just like hole #7 beware of the front right pin position!                </p>
                <div class="row">
              ...
              <div class="col col-12 col-lg-6 ">
                <figure class="mb-0">
                <img src="./assets/images/1_golf_images/holes/Hole-8.jpeg" alt="image of hole eight from the tee box"

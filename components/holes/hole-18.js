    ...
    <div class="container contact__form px-lg-5">
        <div class="row d-flex flex-column-reverse flex-lg-row justify-content-between g-0">
              <div class="col col-12 col-lg-5">
                ...
                <p class="text">
                This hole sets up to favor the left side of the fairway because the contour of the fairway slopes left to right. Any tee shot missed to the right results in a difficult approach short with the ball below your feet and not being able to see the surface of the green.
The green is deceptively difficult to putt as there is a tendency to over-read the break on this green. This hole should give up some birdies but never seems to give up very many! Of course, you can say that about almost every hole At The Hill!                </p>
                <div class="row">
              ...
              <div class="col col-12 col-lg-6 ">
                <figure class="mb-0">
                  <img src="./assets/images/1_golf_images/holes/Hole-18.jpg" alt="image of hole eighteen from the tee box"

      ...
      <div class="container contact__form px-lg-5">
        ...
        >
          <div class="col col-12 col-lg-5">
            ...
            <p class="text">
              A semi-blind tee shot with everything sloping from left to right.
              The recent bunker renovation positioned new bunkers left and right
              to guard the green from long drivers and the approach is made more
              difficult due to the golf ball being well “below” the golfer’s
              feet. The green is slightly elevated and beware of any pin
              positions on the front right! Many golfers have putted balls right
              off the green from this position.
            </p>
            <div class="row">
          ...
          <div class="col col-12 col-lg-6 ">
            <figure class="mb-0">
              <img
                src="./assets/images/1_golf_images/holes/Hole-7.jpeg"
                alt="image of hole seven from the tee box"

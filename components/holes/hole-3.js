    ...
    <div class="container contact__form px-lg-5">
        <div class="row d-flex flex-column-reverse flex-lg-row justify-content-between g-0">
              <div class="col col-12 col-lg-5">
                ...
                <p class="text">
                This new green opened for play in May of 2011.  It is one of the prettiest par 3’s in Central Kentucky!  The green is completely in view and invites you to hit the ball right at the pin.  Three bunkers frame the green and the prevailing wind crosses from the golfers right so whether the wind “helps or hurts” your tee shot distance is difficult to determine.  Also, beware that the green putts a little faster going “uphill” than it looks.                </p>
                <div class="row">
              ...
              <div class="col col-12 col-lg-6 ">
                <figure class="mb-0">
                  <img  src="./assets/images/1_golf_images/holes/Hole-3.jpeg" alt="image of hole three"
